...
namespace stl {
	...
	using StlParamsFunctionMap = std::map<std::string, std::function<StlParams(StlParams&, int)>>;

	StlParamsFunctionMap getStlParamsFunctionMap()
	{
		StlParamsFunctionMap functionMap2;

		std::function< stl::StlParams(stl::StlParams&, int)> calc = &stl::StlParams::seasonal_length;

		functionMap2["seasonal_length"] = &stl::StlParams::seasonal_length;
		functionMap2["trend_length"] = &stl::StlParams::trend_length;
		functionMap2["low_pass_length"] = &stl::StlParams::low_pass_length;
		functionMap2["seasonal_degree"] = &stl::StlParams::seasonal_degree;
		functionMap2["trend_degree"] = &stl::StlParams::trend_degree;
		functionMap2["low_pass_degree"] = &stl::StlParams::low_pass_degree;
		functionMap2["seasonal_jump"] = &stl::StlParams::seasonal_jump;
		functionMap2["trend_jump"] = &stl::StlParams::trend_jump;
		functionMap2["low_pass_jump"] = &stl::StlParams::low_pass_jump;
		functionMap2["inner_loops"] = &stl::StlParams::inner_loops;
		functionMap2["outer_loops"] = &stl::StlParams::outer_loops;
		functionMap2["robust"] = &stl::StlParams::robust;
